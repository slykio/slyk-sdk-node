 ...
 */
var MovementManager = /*#__PURE__*/function (_AbstractManager) {
  (0, _inherits2.default)(MovementManager, _AbstractManager);

  var _super = _createSuper(MovementManager);
  ...
  (0, _createClass2.default)(MovementManager, [{
    ...
    function () {
      var _get = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(id, options) {
        var _yield$this$resolver$, movement;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                movement = _yield$this$resolver$.data;
                return _context.abrupt("return", this.instantiate(movement));
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                results = (0, _lodash.map)((0, _lodash.get)(result, 'data', []), function (movement) {
                  return _this.instantiate(movement);
                });
