...
function (_AbstractManager) {
  ...
  function AssetManager() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(AssetManager).apply(this, arguments));
  }
  ...
  (0, _createClass2.default)(AssetManager, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _ref = _context.sent;
                asset = _ref.data;
                return _context.abrupt("return", this._instantiate(asset));
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee2(code, options) {
        var _ref2, data;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee4(code, data) {
        var _ref3, asset;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                asset = _ref3.data;
                return _context4.abrupt("return", this._instantiate(asset));
