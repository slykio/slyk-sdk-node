 ...
 * Export `AssetManager`.
 */
var AssetManager = /*#__PURE__*/function (_AbstractManager) {
  (0, _inherits2.default)(AssetManager, _AbstractManager);

  var _super = _createSuper(AssetManager);

  function AssetManager() {
    (0, _classCallCheck2.default)(this, AssetManager);
    return _super.apply(this, arguments);
  }

  (0, _createClass2.default)(AssetManager, [{
    key: "create",
    value:
    /**
     * Create.
    ...
    function () {
      var _create = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(data) {
        var _yield$this$resolver$, asset;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                asset = _yield$this$resolver$.data;
                return _context.abrupt("return", this.instantiate(asset));
    ...
    key: "get",
    value: function () {
      var _get = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(code, options) {
    ...
    key: "patch",
    value: function () {
      var _patch = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4(code, data) {
        var _yield$this$resolver$3, asset;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                asset = _yield$this$resolver$3.data;
                return _context4.abrupt("return", this.instantiate(asset));
