 ...
 * Export `WebhookModel`.
 */
var WebhookModel = /*#__PURE__*/function (_AbstractModel) {
  (0, _inherits2.default)(WebhookModel, _AbstractModel);

  var _super = _createSuper(WebhookModel);

  function WebhookModel() {
    (0, _classCallCheck2.default)(this, WebhookModel);
    return _super.apply(this, arguments);
  }

  (0, _createClass2.default)(WebhookModel, [{
    key: "delete",
    value:
    /**
     * Delete.
