...
function (_AbstractManager) {
  ...
  function TaxRateManager() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(TaxRateManager).apply(this, arguments));
  }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _ref = _context.sent;
                taxRate = _ref.data;
                return _context.abrupt("return", this._instantiate(taxRate));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                taxRate = _ref2.data;
                return _context3.abrupt("return", this._instantiate(taxRate));
            ...
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                results = (0, _lodash.map)((0, _lodash.get)(result, 'data', []), function (taxRate) {
                  return _this._instantiate(taxRate);
                });
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                taxRate = _ref3.data;
                return _context5.abrupt("return", this._instantiate(taxRate));
