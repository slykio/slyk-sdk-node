 ...
 */
var TaxRateManager = /*#__PURE__*/function (_AbstractManager) {
  (0, _inherits2.default)(TaxRateManager, _AbstractManager);

  var _super = _createSuper(TaxRateManager);

  function TaxRateManager() {
    (0, _classCallCheck2.default)(this, TaxRateManager);
    return _super.apply(this, arguments);
  }

  (0, _createClass2.default)(TaxRateManager, [{
    key: "create",
    value:
    /**
     * Create.
    ...
    function () {
      var _create = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(data) {
        var _yield$this$resolver$, taxRate;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                taxRate = _yield$this$resolver$.data;
                return _context.abrupt("return", this.instantiate(taxRate));
    ...
    value: function () {
      var _get = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(id, options) {
        var _yield$this$resolver$2, taxRate;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                taxRate = _yield$this$resolver$2.data;
                return _context3.abrupt("return", this.instantiate(taxRate));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                results = (0, _lodash.map)((0, _lodash.get)(result, 'data', []), function (taxRate) {
                  return _this.instantiate(taxRate);
                });
    ...
    value: function () {
      var _patch = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5(id, data) {
        var _yield$this$resolver$3, taxRate;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                taxRate = _yield$this$resolver$3.data;
                return _context5.abrupt("return", this.instantiate(taxRate));
...
exports.default = TaxRateManager;
