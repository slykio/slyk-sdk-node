 ...
 */
var ProductCategoryManager = /*#__PURE__*/function (_AbstractManager) {
  (0, _inherits2.default)(ProductCategoryManager, _AbstractManager);

  var _super = _createSuper(ProductCategoryManager);
  ...
  (0, _createClass2.default)(ProductCategoryManager, [{
    ...
    function () {
      var _create = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(data) {
        var _yield$this$resolver$, productCategory;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                productCategory = _yield$this$resolver$.data;
                return _context.abrupt("return", this.instantiate(productCategory));
    ...
    value: function () {
      var _get = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(id, options) {
        var _yield$this$resolver$2, productCategory;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                productCategory = _yield$this$resolver$2.data;
                return _context3.abrupt("return", this.instantiate(productCategory));
            ...
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                results = (0, _lodash.map)((0, _lodash.get)(result, 'data', []), function (productCategory) {
                  return _this.instantiate(productCategory);
                });
    ...
    value: function () {
      var _patch = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5(id, data) {
        var _yield$this$resolver$3, productCategory;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                productCategory = _yield$this$resolver$3.data;
                return _context5.abrupt("return", this.instantiate(productCategory));
    ...
    key: "reorder",
    value: function () {
      var _reorder = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6(id, data) {
