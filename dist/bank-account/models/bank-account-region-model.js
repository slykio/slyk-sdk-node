 ...
 */
var BankAccountRegionModel = /*#__PURE__*/function (_AbstractModel) {
  (0, _inherits2.default)(BankAccountRegionModel, _AbstractModel);

  var _super = _createSuper(BankAccountRegionModel);
  ...
  (0, _createClass2.default)(BankAccountRegionModel, [{
    ...
    function getAssets(options) {
      return BankAccountRegionModel.sdk.asset.list(_objectSpread(_objectSpread({}, options), {}, {
        filter: {
